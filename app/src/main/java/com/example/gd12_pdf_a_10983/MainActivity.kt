package com.example.gd12_pdf_a_10983
...
import com.example.gd12_pdf_a_10983.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        val document = DocumentsContract.Document(pdfDocument)
